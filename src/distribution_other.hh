...
//----------------------------------------------------------------------------------------------------------------------------------------------------
// DistributionMomentumPositionUniform class declaration
//----------------------------------------------------------------------------------------------------------------------------------------------------

//! Readable name of the DistributionMomentumPositionUniform class
const std::string dist_name_momentum_position_uniform = "DistributionMomentumPositionUniform";
...
*/
class DistributionMomentumPositionUniform : public DistributionUniform<double> {
...
//! Default constructor
   DistributionMomentumPositionUniform(void);

//! Copy constructor
   DistributionMomentumPositionUniform(const DistributionMomentumPositionUniform& other);

//! Destructor
   ~DistributionMomentumPositionUniform() override = default;

//! Clone function
   CloneFunctionDistribution(DistributionMomentumPositionUniform);
};
