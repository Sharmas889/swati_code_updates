...
int main(int argc, char** argv)
{
   ...
   std::string infilename1 = "results/14oct/distro_xsh_fix_mom_500k_dt_1k.dat";
   std::string outfilename = "results/14oct/modulated_distro_xsh_fix_mom_500k_dt_1k.dat";
